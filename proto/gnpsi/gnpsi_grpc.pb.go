...
func (c *gNPSIClient) Subscribe(ctx context.Context, in *Request, opts ...grpc.CallOption) (GNPSI_SubscribeClient, error) {
	...
	stream, err := c.cc.NewStream(ctx, &GNPSI_ServiceDesc.Streams[0], GNPSI_Subscribe_FullMethodName, cOpts...)
	if err != nil {
		return nil, err
	}
	x := &gNPSISubscribeClient{ClientStream: stream}
...
func _GNPSI_Subscribe_Handler(srv interface{}, stream grpc.ServerStream) error {
	...
	return srv.(GNPSIServer).Subscribe(m, &gNPSISubscribeServer{ServerStream: stream})
}
...
var GNPSI_ServiceDesc = grpc.ServiceDesc{
	...
	Metadata: "github.com/openconfig/gnpsi/proto/gnpsi/gnpsi.proto",
}
